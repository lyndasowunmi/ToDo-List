  ...
  return (
    <div id="todo-list">
      ...
      {todos.map((todo) => <div key={todo.id} className="todo">
        ...
        <div>
          <button id="todo-icons" className="todo-actions" onClick={() => deleteTodo(todo.id)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
          ...
          {todoEditing === todo.id ?
            (<button id="todo-edit-icons" onClick={() => editTodo(todo.id)}>Save</button>)
            :
